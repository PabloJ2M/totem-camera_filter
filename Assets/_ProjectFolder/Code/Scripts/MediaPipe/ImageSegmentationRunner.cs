...
{
    public class ImageSegmentationRunner : VisionTaskApiRunner<ImageSegmenter>
    {
        [SerializeField] private ImageSegmentationResult _imageSegmenterResultAnnotationController;
